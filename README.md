...
- Mascara da palavra com atualizacao progressiva.
- Controlo de letras usadas.
...
- Encerramento do jogo com vitoria ou derrota.
- Suporte para varios vencedores.
...
- `src/main/java/com/hangman/server/GameManager.java`: guarda o estado da palavra, tentativas, letras usadas e vencedores.
